...
Because a retry re-runs your block, anything in it *isn't* just a database call that would happen twice. If your block sends an email or charges a card, opt out of it by using `noRetry` for e.g.,:
